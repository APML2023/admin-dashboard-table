...
const MvrTable = ({ column, title, data, from, to }) => {
  ...
  const TotalService =
    getCount("customerGreeting") +
    getCount("knowledgeOfProducts") +
    getCount("convincingCustomerForPhoneNumber") +
    getCount("handlingCustomerComplaintsAndInquiries") +
    getCount("cleanlinessOfStore") +
    getCount("atmosphereAndDecor");
  const TotalVisi =
    getCount("cleanExteriorSignage") + getCount("easeOfAccess") + getCount("facadeMaintained");
  const TotalKnow =
    getCount("understandingOfLocalMarket") +
    getCount("crmActivities") +
    getCount("competitorAwareness");
  const TotalMark = getCount("executionOfPromotionalActivities");
  const Totaltrain =
    getCount("strategiesToUpsellAndCrossSell") +
    getCount("initiativeAtLocalLevel") +
    getCount("kocFiled") +
    getCount("minimizationOfWastageProducts") +
    getCount("optimizationOfProductMix") +
    getCount("managementOfOnlineSales") +
    getCount("adherenceToOperationalStandards");
            ...
            >
              <thead className="table-head">
                <tr>
                  ...
                  <th style={{ minWidth: "100px", maxWidth: "100px" }}>shopName</th>
                  <th>employeeName</th>
                  {/* <th>manager</th> */}
                  ...
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      Shelves Temperature {getCount("shelvesTemperature")}
                    </th>
                  )}
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      Freshness of Goods {getCount("freshnessOfGoods")}
                    </th>
                  )}
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      Variety of Goods {getCount("varietyOfGoods")}
                    </th>
                  )}
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      Presentation of Packaging Items {getCount("presentationOfPackagingItems")}
                    </th>
                  )}
                  {isExpandOpions && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  <th>
                    ...
                    <input
                      type="checkbox"
                      style={{ width: "20px", height: "20px" }}
                      onClick={() => setIsExpandService(!isExpandService)}
                    />
                  </th>
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      customerGreeting {getCount("customerGreeting")}
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      customerGreetingRemark
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      knowledgeOfProducts {getCount("knowledgeOfProducts")}
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      knowledgeOfProductsRemark
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      convincingCustomerForPhoneNumbe {getCount("convincingCustomerForPhoneNumber")}
                      r
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      convincingCustomerForPhoneNumberRemark
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      handlingCustomerComplaintsAndInquiriesRemark
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      cleanlinessOfStore {getCount("cleanlinessOfStore")}
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      cleanlinessOfStoreRemark
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      atmosphereAndDecor {getCount("atmosphereAndDecor")}
                    </th>
                  )}
                  {isExpandService && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      atmosphereAndDecorRemark
                    </th>
                  )}
                  ...
                  <th>
                    ...
                    <input
                      type="checkbox"
                      style={{ width: "20px", height: "20px" }}
                      onClick={() => setIsExpandVisibility(!isExpandVisibility)}
                    />
                  </th>
                  {isExpandVisibility && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      cleanExteriorSignage {getCount("cleanExteriorSignage")}
                    </th>
                  )}
                  {isExpandVisibility && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      cleanExteriorSignageRemark
                    </th>
                  )}
                  {isExpandVisibility && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      easeOfAccess {getCount("easeOfAccess")}
                    </th>
                  )}
                  {isExpandVisibility && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  {isExpandVisibility && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      facadeMaintained {getCount("facadeMaintained")}
                    </th>
                  )}
                  {isExpandVisibility && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      facadeMaintainedRemark
                    </th>
                  )}
                  ...
                  <th>
                    ...
                    <input
                      type="checkbox"
                      style={{ width: "20px", height: "20px" }}
                      onClick={() => setIsExpandKnowledge(!isExpandKnowledge)}
                    />
                  </th>
                  {isExpandKnowledge && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      understandingOfLocalMarket {getCount("understandingOfLocalMarket")}
                    </th>
                  )}
                  {isExpandKnowledge && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      understandingOfLocalMarketRemark
                    </th>
                  )}
                  {isExpandKnowledge && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      crmActivities {getCount("crmActivities")}
                    </th>
                  )}
                  {isExpandKnowledge && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                  ...
                  {isExpandKnowledge && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      competitorAwareness {getCount("competitorAwareness")}
                    </th>
                  )}
                  {isExpandKnowledge && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      competitorAwarenessRemark
                    </th>
                  )}
                  ...
                  <th>
                    ...
                    <input
                      type="checkbox"
                      style={{ width: "20px", height: "20px" }}
                      onClick={() => setIsExpandMarketing(!isExpandMarketing)}
                    />
                  </th>
                  {isExpandMarketing && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      executionOfPromotionalActivities{" "}
                      {getCount("executionOfPromotionalActivities")}
                    </th>
                  )}
                  {isExpandMarketing && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      executionOfPromotionalActivitiesRemark
                    </th>
                  )}
                  ...
                  <th>
                    ...
                    <input
                      type="checkbox"
                      style={{ width: "20px", height: "20px" }}
                      onClick={() => setIsExpandTraining(!isExpandTraining)}
                    />
                  </th>
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      strategiesToUpsellAndCrossSell {getCount("strategiesToUpsellAndCrossSell")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      strategiesToUpsellAndCrossSellRemark
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      initiativeAtLocalLevel {getCount("initiativeAtLocalLevel")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      initiativeAtLocalLevelRemark
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      kocFiled {getCount("kocFiled")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>kocFiledRemark</th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      minimizationOfWastageProducts {getCount("minimizationOfWastageProducts")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      minimizationOfWastageProductsRemark
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      optimizationOfProductMix {getCount("optimizationOfProductMix")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      optimizationOfProductMixRemark
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      managementOfOnlineSales {getCount("managementOfOnlineSales")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      managementOfOnlineSalesRemark
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      adherenceToOperationalStandards {getCount("adherenceToOperationalStandards")}
                    </th>
                  )}
                  {isExpandTraining && (
                    <th style={{ backgroundColor: "#684F31", color: "white" }}>
                      adherenceToOperationalStandardsRemark
                    </th>
                  )}
                  <th>Strength</th>
                  <th>Opportunites</th>
                ...
                {finalData.map((d, i) => {
                  return (
                    <tr key={i}>
                      ...
                      <td>
                        {Number(d.customerGreeting == "N/A" ? 0 : d.customerGreeting) +
                      ...
                      <td>
                        {QualityProduct(
                          d.shelvesTemperature == "N/A" ? 0 : d.shelvesTemperature,
                          d.freshnessOfGoods == "N/A" ? 0 : d.freshnessOfGoods,
                          d.varietyOfGoods == "N/A" ? 0 : d.varietyOfGoods,
                          d.presentationOfPackagingItems == "N/A"
                            ? 0
                            : d.presentationOfPackagingItems
                        )}
                      </td>
                      {isExpandOpions && (
                        <td
                          style={{
                            color: d.shelvesTemperature == "0" ? "white" : "",
                            backgroundColor: d.shelvesTemperature == "0" ? "red" : "",
                          }}
                        >
                          {" "}
                          <a
                            href={d.shelvesTemperature == "0" ? d.shelvesTemperatureLink : ""}
                            target="_blank"
                          >
                            {" "}
                            {d.shelvesTemperature == "N/A" ? 0 : d.shelvesTemperature}
                      ...
                      {isExpandOpions && (
                        <td
                          style={{
                            color: d.varietyOfGoods == "0" ? "white" : "",
                            backgroundColor: d.varietyOfGoods == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.varietyOfGoods == "0" ? d.varietyOfGoodsLink : ""}
                            target="_blank"
                          >
                            {" "}
                            {d.varietyOfGoods}
                      ...
                      {isExpandOpions && (
                        <td
                          style={{
                            color: d.freshnessOfGoods == "0" ? "white" : "",
                            backgroundColor: d.freshnessOfGoods == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.freshnessOfGoods == "0" ? d.freshnessOfGoodsLink : ""}
                            target="_blank"
                          >
                            {" "}
                            {d.freshnessOfGoods}
                      ...
                      {isExpandOpions && (
                        ...
                        >
                          <a
                            href={
                              d.presentationOfPackagingItemsfreshnessOfGoods == "0"
                                ? d.presentationOfPackagingItemsfreshnessOfGoodsLink
                                : ""
                            }
                            target="_blank"
                          >
                            {d.presentationOfPackagingItemsfreshnessOfGoods}
                          </a>
                        </td>
                      )}
                      {isExpandOpions && (
                        <td
                          style={{
                            color: d.presentationOfPackagingItemsRemark == "0" ? "white" : "",
                            backgroundColor:
                              d.presentationOfPackagingItemsRemark == "0" ? "red" : "",
                          }}
                        >
                          {d.presentationOfPackagingItemsRemark}
                        </td>
                      )}

                      <td>
                        {Service(
                          d.customerGreeting == "N/A" ? 0 : d.customerGreeting,
                          d.knowledgeOfProducts == "N/A" ? 0 : d.knowledgeOfProducts,
                          d.convincingCustomerForPhoneNumber == "N/A"
                            ? 0
                            : d.convincingCustomerForPhoneNumber,
                          d.handlingCustomerComplaintsAndInquiries == "N/A"
                            ? 0
                            : d.handlingCustomerComplaintsAndInquiries,
                          d.cleanlinessOfStore == "N/A" ? 0 : d.cleanlinessOfStore,
                          d.atmosphereAndDecor == "N/A" ? 0 : d.atmosphereAndDecor
                        )}
                      </td>
                      {isExpandService && (
                        <td
                          style={{
                            color: d.customerGreeting == "0" ? "white" : "",
                            backgroundColor: d.customerGreeting == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.customerGreeting == "0" ? d.customerGreetingLink : ""}
                            target="_blank"
                          >
                            {d.customerGreeting}
                          </a>
                      ...
                      {isExpandService && (
                        <td
                          style={{
                            color: d.knowledgeOfProducts == "0" ? "white" : "",
                            backgroundColor: d.knowledgeOfProducts == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.knowledgeOfProducts == "0" ? d.knowledgeOfProductsLink : ""}
                            target="_blank"
                          >
                            {d.knowledgeOfProducts}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandService && (
                        <td
                          style={{
                            color: d.convincingCustomerForPhoneNumber == "0" ? "white" : "",
                            backgroundColor: d.convincingCustomerForPhoneNumber == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.convincingCustomerForPhoneNumber == "0"
                                ? d.convincingCustomerForPhoneNumberLink
                                : ""
                            }
                            target="_blank"
                          >
                      ...
                      {isExpandService && (
                        <td
                          style={{
                            color: d.handlingCustomerComplaintsAndInquiries == "0" ? "white" : "",
                            backgroundColor:
                              d.handlingCustomerComplaintsAndInquiries == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.handlingCustomerComplaintsAndInquiries == "0"
                                ? d.handlingCustomerComplaintsAndInquiriesLink
                                : ""
                            }
                            target="_blank"
                          >
                      ...
                      {isExpandService && (
                        <td
                          style={{
                            color: d.cleanlinessOfStore == "0" ? "white" : "",
                            backgroundColor: d.cleanlinessOfStore == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.cleanlinessOfStore == "0" ? d.cleanlinessOfStoreLink : ""}
                            target="_blank"
                          >
                      ...
                      {isExpandService && (
                        <td
                          style={{
                            color: d.atmosphereAndDecor == "0" ? "white" : "",
                            backgroundColor: d.atmosphereAndDecor == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.atmosphereAndDecor == "0" ? d.atmosphereAndDecorLink : ""}
                            target="_blank"
                          >
                            {d.atmosphereAndDecor}
                          </a>
                        </td>
                      )}
                      ...
                      <td>
                        {Visibility(
                          d.cleanExteriorSignage == "N/A" ? 0 : d.cleanExteriorSignage,
                          d.easeOfAccess == "N/A" ? 0 : d.easeOfAccess,
                          d.facadeMaintained == "N/A" ? 0 : d.facadeMaintained
                        )}
                      </td>
                      {isExpandVisibility && (
                        <td
                          style={{
                            color: d.cleanExteriorSignage == "0" ? "white" : "",
                            backgroundColor: d.cleanExteriorSignage == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.cleanExteriorSignage == "0" ? d.cleanExteriorSignageLink : ""}
                            target="_blank"
                          >
                            {d.cleanExteriorSignage}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandVisibility && (
                        <td
                          style={{
                            color: d.easeOfAccess == "0" ? "white" : "",
                            backgroundColor: d.easeOfAccess == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.easeOfAccess == "0" ? d.easeOfAccessLink : ""}
                            target="_blank"
                          >
                            {d.easeOfAccess}
                          </a>
                      ...
                      {isExpandVisibility && (
                        <td
                          style={{
                            color: d.facadeMaintained == "0" ? "white" : "",
                            backgroundColor: d.facadeMaintained == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.facadeMaintained == "0" ? d.facadeMaintainedLink : ""}
                            target="_blank"
                          >
                            {d.facadeMaintained}
                          </a>
                      ...
                      <td>
                        {Knowledge(
                          d.understandingOfLocalMarket == "N/A" ? 0 : d.understandingOfLocalMarket,
                          d.crmActivities == "N/A" ? 0 : d.crmActivities,
                          d.competitorAwareness == "N/A" ? 0 : d.competitorAwareness
                        )}
                      </td>
                      {isExpandKnowledge && (
                        <td
                          style={{
                            color: d.understandingOfLocalMarket == "0" ? "white" : "",
                            backgroundColor: d.understandingOfLocalMarket == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.understandingOfLocalMarket == "0"
                                ? d.understandingOfLocalMarketLink
                                : ""
                            }
                            target="_blank"
                          >
                            {d.understandingOfLocalMarket}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandKnowledge && (
                        <td
                          style={{
                            color: d.crmActivities == "0" ? "white" : "",
                            backgroundColor: d.crmActivities == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.crmActivities == "0" ? d.crmActivitiesLink : ""}
                            target="_blank"
                          >
                            {d.crmActivities}
                          </a>
                      ...
                      {isExpandKnowledge && (
                        <td
                          style={{
                            color: d.competitorAwareness == "0" ? "white" : "",
                            backgroundColor: d.competitorAwareness == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.competitorAwareness == "0" ? d.competitorAwarenessLink : ""}
                            target="_blank"
                          >
                            {d.competitorAwareness}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandMarketing && (
                        <td
                          style={{
                            color: d.executionOfPromotionalActivities == "0" ? "white" : "",
                            backgroundColor: d.executionOfPromotionalActivities == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.executionOfPromotionalActivities == "0"
                                ? d.executionOfPromotionalActivitiesLink
                                : ""
                            }
                            target="_blank"
                          >
                      ...
                      <td>
                        {Marketing(
                          d.strategiesToUpsellAndCrossSell == "N/A"
                            ? 0
                            : d.strategiesToUpsellAndCrossSell,
                          d.initiativeAtLocalLevel == "N/A" ? 0 : d.initiativeAtLocalLevel,
                          d.kocFiled == "N/A" ? 0 : d.kocFiled,
                          d.minimizationOfWastageProducts == "N/A"
                            ? 0
                            : d.minimizationOfWastageProducts,
                          d.optimizationOfProductMix == "N/A" ? 0 : d.optimizationOfProductMix,
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.strategiesToUpsellAndCrossSell == "0" ? "white" : "",
                            backgroundColor: d.strategiesToUpsellAndCrossSell == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.strategiesToUpsellAndCrossSell == "0"
                                ? d.strategiesToUpsellAndCrossSellLink
                                : ""
                            }
                            target="_blank"
                          >
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.initiativeAtLocalLevel == "0" ? "white" : "",
                            backgroundColor: d.initiativeAtLocalLevel == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.initiativeAtLocalLevel == "0" ? d.initiativeAtLocalLevelLink : ""
                            }
                            target="_blank"
                          >
                            {d.initiativeAtLocalLevel}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.kocFiled == "0" ? "white" : "",
                            backgroundColor: d.kocFiled == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={d.kocFiled == "0" ? d.kocFiledLink : ""}
                            target="_blank"
                          >
                            {d.kocFiled}
                          </a>
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.minimizationOfWastageProducts == "0" ? "white" : "",
                            backgroundColor: d.minimizationOfWastageProducts == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.minimizationOfWastageProducts == "0"
                                ? d.minimizationOfWastageProductsLink
                                : ""
                            }
                            target="_blank"
                          >
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.optimizationOfProductMix == "0" ? "white" : "",
                            backgroundColor: d.optimizationOfProductMix == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.optimizationOfProductMix == "0"
                                ? d.optimizationOfProductMixLink
                                : ""
                            }
                            target="_blank"
                          >
                            {d.optimizationOfProductMix}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.managementOfOnlineSales == "0" ? "white" : "",
                            backgroundColor: d.managementOfOnlineSales == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.managementOfOnlineSales == "0" ? d.managementOfOnlineSalesLink : ""
                            }
                            target="_blank"
                          >
                            {d.managementOfOnlineSales}
                          </a>
                        </td>
                      )}
                      ...
                      {isExpandTraining && (
                        <td
                          style={{
                            color: d.adherenceToOperationalStandards == "0" ? "white" : "",
                            backgroundColor: d.adherenceToOperationalStandards == "0" ? "red" : "",
                          }}
                        >
                          <a
                            href={
                              d.adherenceToOperationalStandards == "0"
                                ? d.adherenceToOperationalStandardsLink
                                : ""
                            }
                            target="_blank"
                          >
                      ...
                      <td>
                        <textarea>{d.strength}</textarea>
                      </td>
                      <td>
                        <textarea>{d.opportunities}</textarea>
                      </td>
                      <td>
                        <textarea>{d.actionable}</textarea>
                      </td>
                    </tr>
                  );
                })}
...
const TableHeadingColumn = ({ isExpandOpions, setIsExpandOptions, item, data, cobj, total }) => {
  useEffect(() => {}, [isExpandOpions]);

  return (
    <th>
      {item.heading} - {item.heading == "Quality Products" ? total : cobj[item?.value]}{" "}
      {item.heading == "Quality Products" && (
        <input
          onClick={() => setIsExpandOptions(!isExpandOpions)}
          type="checkbox"
          style={{ width: "20px", height: "20px" }}
